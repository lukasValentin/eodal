...
class STAC_Providers:
    class AWS:
        ...
        class Sentinel2:
            ...
            epsg: str = "proj:epsg"
            sun_azimuth_angle = "view:sun_azimuth"
            sun_zenith_angle = "view:sun_elevation"
    ...
    class MSPC:
        ...
        S2Level_1C: str = "sentinel-2-l1c"
        S2Level_2A: str = "sentinel-2-l2a"
        S1RTC: str = "sentinel-1-rtc"  # radiometry and terrain corrected
        S1GRD: str = (
    ...
    class Copernicus:
        """Copernicus Data Space Ecosystem (not stable yet)"""

        URL: str = "https://catalogue.dataspace.copernicus.eu/stac"
        S2Level_2A: str = 'SENTINEL-2'
